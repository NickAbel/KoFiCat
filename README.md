...
- [x] Choose and generate a complete sentence set for a common representative of each leaf-level tick mark of the KOFI taxonomy.
...
- [x] **Regular** (In the first conjugation, all verbs except for the above-listed auxiliaries **estar** and **anar** are regular.)
  ...
  - [x] **Spelling Change: -car(2)**: This orthographic change covers the vast majority of verbs ending in -car. **Destacar** is the chosen representative.
  ...
  - [x] **Spelling Change: -aiar/-eiar/-oiar(6)**: This orthographic change covers a group of verbs ending in -aiar/-eiar/-oiar. **Remeiar** is the chosen representative.
  ...
  - [x] **Spelling Change: -aiguar(8)**: This orthographic change covers a group of verbs ending in -aiguar. **Enaiguar** is the chosen representative.
  - [x] **Spelling Change: -quar(9)**: This orthographic change covers a group of verbs ending in -quar. **Adequar** is the chosen representative.

## Conjugation II
- [x] (i)   **Infinitive in -re**
  - [x] **Regular, No Spelling Changes**: This conjugation pattern only covers a minority of the category II(i) verbs. **Batre** is the chosen representative.
  - [x] **Irregularity in Participles Only(1)**: This conjugation pattern is regular, except for irregularity in the participles. **Admetre** is the chosen representative.
  ...
  - [x] **Irregularity: -cloure(8)**: **Encloure** is the chosen representative.
  ...
  - [x] **Irregularity: -moldre(16)**: **Moldre** is the chosen representative.
  - [x] **Irregularity: -jeure(17)**: **Jeure** is the chosen representative.
  - [x] **Irregularity: -riure(18)**: **Riure** is the chosen representative.
  - [x] **Irregularity: Heure(19)**
  - [x] **Irregularity: Cerndre(20)**
  - [x] **Irregularity: Coure(21)**
  - [x] **Irregularity: Romandre(22)**
  - [x] **Irregularity (defective): Ploure(23)**
  - [x] **Irregularity (defective): Lleure(24)**
  - [x] **Irregularity (defective): Caldre(25)**
  - [x] **Irregularity: Cabre(26)**
  - [x] **Irregularity, with novelty only in participles: -pondre(27)**: **Pondre** is the chosen representative.
  - [x] **Irregularity: Raure(28)**
...
- [x] (ii)  **Infinitive in unstressed -er**:
  - [x] **Regular, No Spelling Changes**: **Témer** is the chosen representative.
  - [x] **Spelling Change: -tòrcer(1)**: **Tòrcer** is the chosen representative.
  - [x] **Irregularity in Participle Only: -strènyer(2)**: **Constrènyer** is the chosen representative.
...
- [x] (iv)  **Infinitive in stressed -er**:
...
- [x] (a) **Inchoative**
  ...
  - [x] **Spelling Change: -uir/-eir/-air/-oir(1)**: This orthographic change covers the vast majority of verbs ending in -uir, all verbs ending in -eir/-air, **oir**, and **corroir**. **Construir** is the chosen representative.
  - [x] **Irregularity in Participles Only: -rir(2)**: **Cobrir** is the chosen representative.
  - [x] **Irregularity in Participles Only: -imprimir(3)**: **Imprimir** is the chosen representative.
...
- [x] (b) **Pure**
  ...
  - [x] **Irregularity: Escopir(6)**
  - [x] **Irregularity: Tossir(7)**
  - [x] **Irregularity: Pudir(8)**
...
- [x] **Irregularity: -lluir(2)**: **Lluir** is the chosen representative.
